      ...
      <div class="row justify-content-around">
        <form action="" class="col-md-8 bg-light p-3 my-3" method="POST" enctype ="multipart/form-data" >
          ...
          <div class="form-group ">
            ...
            <input type="text" name ="title" id="title" class="form-control" placeholder="Tiêu đề " required value="{{old('title')}}">
            @error('title')
          ...
          <div class="form-group">
            ...
            <input type="date" name ="time" id="time" class="form-control" required value="{{old('time')}}">
            @error('time')
            <span style="color: red;">{{$message}}</span>
            @enderror
          </div>
